...
class Atri:
	...
	def links(self, new_state):
		...
		global default_state
		self._links = Div(new_state, default_state["links"])
	...
	@property
	def profile(self):
		self._getter_access_tracker["profile"] = {}
		return self._profile
	@profile.setter
	def profile(self, new_state):
		self._setter_access_tracker["profile"] = {}
		global default_state
		self._profile = Image(new_state, default_state["profile"])
