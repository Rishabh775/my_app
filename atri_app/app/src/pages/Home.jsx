...
import { usenavCb, uselinksCb, useFlex2Cb, useDiv2Cb, usebuttonCb, useDiv4Cb, useFlex3Cb, useDiv5Cb, useDiv6Cb, useFlex5Cb, useDiv7Cb, useDiv8Cb, useDiv9Cb, useFlex4Cb, uselogoCb, useLink1Cb, useLink2Cb, useLink3Cb, useLink4Cb, useprofileCb, useTextBox2Cb, useTextBox3Cb, useTextBox4Cb, useTextBox5Cb, useTextBox6Cb, useTextBox7Cb, useButton1Cb, useButton2Cb, useTextBox8Cb, useTextBox9Cb, useTextBox10Cb, useTextBox11Cb, useTextBox13Cb, useTextBox19Cb, useUnorderedList5Cb, useImage12Cb, useTextBox12Cb, useTextBox18Cb, useUnorderedList4Cb, useImage11Cb, useTextBox14Cb, useTextBox15Cb, useUnorderedList1Cb, useImage10Cb, useImage6Cb, useImage7Cb, useImage8Cb, useImage9Cb } from "../page-cbs/Home";
...
const profileProps = useStore((state)=>state["Home"]["profile"]);
const profileIoProps = useIoStore((state)=>state["Home"]["profile"]);
const profileCb = useprofileCb()
...
<Div className="p-Home links bpt" {...linksProps} {...linksCb} {...linksIoProps}>
...
<Image className="p-Home profile bpt" {...profileProps} {...profileCb} {...profileIoProps}/>
</Flex>
